...
import { Calendar, Download, DollarSign, Clock, CheckCircle } from 'lucide-react';
...
const PartnerEarnings = () => {
    ...
    const lastMonthData = monthlyEarnings.find(m => {
        const [y, mo] = m.month.split('-').map(Number);
        return y === lastYear && mo === lastMonthNum;
    });
    const lastMonthPaymentStatus = lastMonthData?.paymentStatus || 'PENDING';
    const lastMonthPaid = lastMonthPaymentStatus === 'PAID' || lastMonthPaymentStatus === 'CONFIRMED';
    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto">
            <div className="bg-gradient-to-r from-[#DE7A3E] to-[#7596DB] rounded-xl p-6 text-white">
                ...
                <p className="text-orange-100 text-lg">Track your commissions and payment status from orders using your coupons.</p>
