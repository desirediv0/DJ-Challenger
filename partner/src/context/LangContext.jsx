...
const translations = {
    en: {
        ...
        dashboard_subtitle: "Here's an overview of your partnership performance with DJ Challenger.",
    ...
    hi: {
        ...
        dashboard_subtitle: 'DJ Challenger के साथ आपकी पार्टनरशिप का सारांश',
